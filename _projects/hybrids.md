...
You can play with a few PRNNs in the following widget. Change the time step slider to see how internal variables inside the latent layer are evolving during a non-proportional non-monotonic strain path; change the epoch slider to see how encoder/decoder weights change during training:
